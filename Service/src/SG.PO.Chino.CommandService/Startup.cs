...
using SG.PO.Chino.CommandService.Core;
...
namespace SG.PO.Chino.CommandService
{
        ...
        public void ConfigureServices(IServiceCollection services)
        {
          ...
          v => LogContext.Push(v.Select(x => (ILogEventEnricher)new PropertyEnricher(x.Key, x.Value)).ToArray())
            ...
            services.AddMvc(options =>
            {
                ...
                options.Filters.Add(typeof(ElasticIndexFilter<POChinoOutput>));
            });
            services.AddLogging();
            services.AddMvcCore().AddJsonFormatters();
            services.AddTransient<POChinoService>();
            ...
            services.AddElastic<POChinoOutput>(options =>
            {
