...
namespace SG.PO.Contempo.CommandService
{
        ...
        public void ConfigureServices(IServiceCollection services)
        {
          ...
          v => LogContext.Push(v.Select(x => (ILogEventEnricher)new PropertyEnricher(x.Key, x.Value)).ToArray())
            ...
            services.AddMvc(options =>
            {
                ...
                options.Filters.Add(typeof(ElasticIndexFilter<POContempoOutput>));
            });
            services.AddLogging();
            services.AddMvcCore().AddJsonFormatters();
            services.AddTransient<POContempoService>();
            services.AddTransient<GetPOSkuLines>();
            services.AddTransient<POContempoProductMapper>();
            ...
            services.AddElastic<POContempoOutput>(options =>
            {
